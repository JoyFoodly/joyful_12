keys = [:box11_text, :box12_text, :box21_text, :box22_text, :box11_header, :box12_header, :box21_header, :box22_header, [:general_welcome_message, nil], [:general_welcome_message, 'NovatoCoupon'], [:welcome_bullets, nil], [:welcome_bullets, 'NovatoCoupon'], :section_title_one, :section_title_two, :rightcolumn_subtext, :section_subtext_one, :section_subtext_two]
...
contents = {box11_header: 'Eat the Rainbox', box11_text: 'Feel great about the meals you make for your family. 12 veggies and fruits', box12_header: 'Time Saving Shopping List', box12_text: 'Make shopping easy with a shopping list. You can email',
            ...
            [:welcome_bullets, 'NovatoCoupon'] => '<p>Start cooking veggies your kids will demand.</P><p>My Joyful 12 Online Learning Lab will help you improve the health of your children with over 100 family friendly recipes to love cooking and eating seasonal veggies every month of the year.</p>',
